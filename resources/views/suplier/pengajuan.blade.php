      ...
      <div class="modal-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control nama_pengadaan" id="nama-pengadaan" name="nama_pengadaan" placeholder="Masukan Nama Pengadaan" disabled>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control gambar" id="proposal" name="proposal" accept="application/pdf">
