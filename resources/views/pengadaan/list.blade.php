                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:15%">
                        ...
                        <hr>
                        <a class="konfirmasi" href="/hapusGambar/{{$p->id_pengadaan}}"><button class="btn-danger"><i class="fas fa-trash"></i> Hapus gambar</button></a>
                          @endif
                          @if($p->gambar == "-")
                          <hr>
...
@endif
  ...
  $(document).on("click", ".konfirmasi", function(event)
  {
    ...
    var answer = window.confirm("Kamu yakin ingin dihapus ?");
